...
env=model_exp_environement_multi_PPF_phase(ObsInfo,ActInfo,Ts, time(1:end/1), V_lp(:,1:end/1), sys_mimo,'rwd_freq',[1 1 1]);
...
filename = sprintf('Data/Reward_param_GMPM_%s.mat',localtime)
save(filename)